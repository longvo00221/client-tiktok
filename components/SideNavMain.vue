<template>
  <div
    ...
    class="fixed z-20 bg-white pt-[70px] h-full lg:border-r-0 border-r w-[75px] overflow-auto scroll-bar-global"
  >
    <div class="lg:w-full w-[55px] mx-auto">
      <NuxtLink to="/">
        <MenuItem iconString="For You" colorString="#F02C566" sizeString="30" />
      </NuxtLink>
      <MenuItem iconString="Following" colorString="#000" sizeString="27" />
      <MenuItem iconString="Explore" colorString="#000" sizeString="27" />
      ...
      >
        <div @click="$e=> isLoggedIn(sug)" class="cursor-pointer">
      ...
      >
        <div @click="$e=> isLoggedIn(fol)" class="cursor-pointer">
      ...
      <div class="lg:block hidden text-[11px] text-gray-500">
        <div class="pt-4 px-2">
          About Newsroom Tiktok Shop Contract Careers ByteDance
        </div>
        <div class="pt-4 px-2">
