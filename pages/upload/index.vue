    ...
    >
      ...
      <div class="mt-8 md:flex gap-6">
        <label
          ...
          @drop.prevent="onDrop"
          @dragover.prevent=""
          class="md:mx-0 mx-auto mt-4 mb-6 flex flex-col items-center justify-center w-full max-w-[100%] md:max-w-[260px] h-[470px] text-center p-3 border-2 border-dashed border-gray-300 rounded-lg hover:bg-gray-100 cursor-pointer"
        >
          <Icon name="majesticons:cloud-upload" size="40" color="#b3b3b1" />
          <span class="mt-4 text-[17px]">Select Video To Upload </span>
          <span class="mt-1.5 text-gray-500 text-[13px]"
            >Or drag and drop a file</span
          >
          <span class="mt-1.5 text-gray-300 text-[13px]">MP4 or WebM</span>
          <span class="mt-1.5 text-gray-300 text-[13px]"
            >720x1280 resolution or higher</span
          >
          <span class="mt-1.5 text-gray-300 text-[13px]">Up to 30 minutes</span>
          <span class="mt-1.5 text-gray-300 text-[13px]">Less than 2 GB</span>
          <div
            class="px-2 py-1.5 mt-8 text-white font-bold text-[15px] w-[80%] bg-[#F02C56] rounded-md"
          >
            Select file
          </div>
          <input
        ...
        >
          ...
          <img
            ...
            width="90"
            class="absolute right-4 bottom-16 z-20"
          />
          <video
            :src="fileDisplay"
            autoplay
        ...
        <div class="mt-4 mb-6">
          ...
          <div class="flex justify-between md:justify-normal gap-3">
            <button
              @click="discard"
              class="px-10 py-2.5 mt-8 border text-[16px] hover:bg-gray-100 rounded-md"
            >
              Discard
            </button>
            <button
              @click="createPost"
              class="px-10 py-2.5 mt-8 border text-[16px] text-white bg-[#F02C56] rounded-md"
            >
              Post
            </button>
          </div>
